                    ...
                    "template": {
                      ...
                      "spec": {
                        ...
                        "initContainers": [{
                            ...
                            'sh', 
                            '-c',
                            f"until nc -zv {deployment_conf['amfIpaddress']} 38412 --sctp ; do echo waiting for {deployment_conf['amfIpaddress']} amf to start; sleep 1; done" 
                            ]
                        }],
                        "containers": [
                          {
                            ...
                            "args": [ f"cat /opt/oai-gnb/etc/cucp.conf;/opt/oai-gnb/bin/nr-softmodem -O /opt/oai-gnb/etc/cucp.conf {deployment_conf['useAdditionalOptions']}"
                            ]
                          }
                        ],
                        "volumes": [
