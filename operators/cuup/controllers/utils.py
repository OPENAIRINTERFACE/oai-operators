                    ...
                    "template": {
                      ...
                      "spec": {
                        ...
                        "initContainers": [{
                            ...
                            'sh', 
                            '-c',
                            f"until nc -zv {deployment_conf['cucpIpaddress']} 38462 --sctp ; do echo waiting for {deployment_conf['cucpIpaddress']} cuup to start; sleep 1; done" 
                            ]
                        }],
                        "containers": [
                          {
                            ...
                            "args": [ f"cat /opt/oai-gnb/etc/cuup.conf;/opt/oai-gnb/bin/nr-cuup -O /opt/oai-gnb/etc/cuup.conf {deployment_conf['useAdditionalOptions']}"
                            ]
                          }
                        ],
                        "volumes": [
